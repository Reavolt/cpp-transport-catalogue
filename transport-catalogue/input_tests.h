...
namespace transport_catalogue::tests
{
    ...
    void ParseRequestType()
    {
        ...
        {
            Reader      in_reader(&catalogue);
            std::string request("Stop Tolstopaltsevo: 55.611087, 37.208290"s);
            ASSERT_EQUAL("Stop", in_reader.ParseRequestType(request));
        ...
        }
        {
            ...
            ASSERT_EQUAL("Bus", in_reader.ParseRequestType(request));
    ...
    void ParseName()
    {
        ...
        }
        {
            ...
            ASSERT_EQUAL("Biryulyovo Tovarnaya", in_reader.ParseName(request));
            ASSERT_EQUAL(request, "55.611087, 37.208290");
        }
        {
            Reader      in_reader(&catalogue);
    ...
    void ParseCoords()
    {
        TransportCatalogue catalogue;
        {
            ...
            Coordinates coordinates = in_reader.ParseCoords(request);
    ...
    void ParseStopsDistance()
    {
        ...
        catalogue.AddStop({"Marushkino", {55.574371, 37.6517}});
        {
            ...
            Reader::StopsDistance stops_distance = in_reader.ParseStopsDistance(request);
    ...
    void ParseStandartRoute()
    {
...

        {
            ...
            Reader::StopsData parsed_data = in_reader.ParseStandartRoute(request);
    ...
    void ParseRingRoute()
    {
...

        {
            ...
            Reader::StopsData parsed_data = in_reader.ParseRingRoute(request);
            ASSERT_EQUAL("Biryulyovo Zapadnoye", parsed_data[0]->name_);
            ASSERT_EQUAL("Biryusinka", parsed_data[1]->name_);
            ASSERT_EQUAL("Universam", parsed_data[2]->name_);
